...
export async function onRequest(context){
  ...
  try{
    ...
    if(isHopePage){
      rewriter=rewriter.on('body',{element(el){el.append('<script src="/hope-voice6.js?v=6.5" defer></script><script src="/hope-ai-telemetry.js?v=1" defer></script>',{html:true})}});
      rewriter=rewriter.on('#drawer',{element(el){el.append('<div class="section">Goals</div><button class="nav" onclick="location.href=\'/hope-goals.html\'">HOPE Goals</button>',{html:true})}});
    }
